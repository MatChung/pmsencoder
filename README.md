...
Due to a [bug](http://code.google.com/p/ps3mediaserver/issues/detail?id=766) in the Mac OS X build of PS3 Media Server, PMSEncoder doesn't currently work on Macs. In addition, PMS doesn't support web streams for Xbox renderers. PMSEncoder should work on all other platforms supported by PS3 Media Server.
